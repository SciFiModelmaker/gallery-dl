...
"""Extractors for https://fapeza.com/"""
...
class FapezaPostExtractor(Extractor):
    ...
    example = "https://fapeza.com/MODEL/12345/"
...
class FapezaModelExtractor(Extractor):
    ...
    pattern = (BASE_PATTERN + r"/(?!top-(?:likes|followers)|popular_videos"
               ...
               r"([^/?#]+)/?$")
    example = "https://fapeza.com/model/"
...
class FapezaPathExtractor(Extractor):
    ...
    pattern = (BASE_PATTERN +
               ...
               r"|popular_videos/[^/?#]+)/?$")
    example = "https://fapeza.com/trending/"
